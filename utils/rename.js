...
(async () => {
	...
	const APK_PATH =
		platformsDir + "/android/app/build/outputs/apk/debug/app-debug.apk";
	const AAB_PATH =
		platformsDir + "/android/app/build/outputs/bundle/release/app-release.aab";
	...
	try {
		...
		var onlyPath = require("node:path").dirname(artifact);
